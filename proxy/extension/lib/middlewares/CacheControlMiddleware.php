 ...
 * exists for a rule using the `static` handler (e.g. the production
 * `frontend` rule), since static files are read straight from disk and have
 * no upstream to refresh from. Rules like those need an explicit
 * `Cache-Control` header instead, which is what this middleware provides.
 *
