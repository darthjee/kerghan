...
|-----|-----------------|--------|---------|
| `backend_tests` | `darthjee/circleci_kerghan-base:0.1.0` | every push | Backend test suite + coverage |
| `backend_checks` | `darthjee/circleci_kerghan-base:0.1.0` | every push | Backend ESLint |
| `jasmine` | `darthjee/circleci_node:0.2.1` | every push | Frontend test suite + coverage |
